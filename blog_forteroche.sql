...
CREATE TABLE IF NOT EXISTS `article_views` (
  ...
  PRIMARY KEY (`id`),
  KEY `article_relation` (`article_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Déchargement des données de la table `article_views`
--

INSERT INTO `article_views` (`id`, `article_id`, `date_visite`, `ip`) VALUES
(2, 1, '2024-05-15 10:52:46', '::1'),
(3, 2, '2024-05-15 10:53:16', '::1'),
(4, 3, '2024-05-15 10:53:18', '::1'),
(5, 1, '2024-05-15 10:54:46', '::1'),
(6, 1, '2024-05-15 11:49:26', '::1'),
(7, 2, '2024-05-15 11:49:29', '::1'),
(8, 3, '2024-05-15 14:47:28', '::1'),
(9, 3, '2024-05-15 14:47:52', '::1'),
(10, 2, '2024-05-15 14:48:13', '::1'),
(11, 2, '2024-05-15 14:55:44', '::1'),
(12, 1, '2024-05-15 15:17:02', '::1'),
(13, 3, '2024-05-15 15:22:56', '::1'),
(14, 2, '2024-05-16 18:14:47', '::1'),
(15, 1, '2024-05-16 18:14:48', '::1'),
(16, 3, '2024-05-16 18:14:48', '::1'),
(17, 3, '2024-05-16 18:17:05', '::1'),
(18, 3, '2024-05-16 18:17:13', '::1'),
(19, 1, '2024-05-16 18:17:17', '::1'),
(20, 1, '2024-05-16 18:17:24', '::1'),
(21, 1, '2024-05-16 18:17:33', '::1'),
(22, 2, '2024-05-16 18:24:29', '::1'),
(23, 1, '2024-05-17 09:14:43', '::1'),
(24, 2, '2024-05-17 09:14:44', '::1'),
(25, 3, '2024-05-17 09:14:44', '::1'),
(26, 1, '2024-05-23 16:53:15', '::1');
...
(21, 2, 'Test ', 'Très beau blog', '2024-05-13 10:11:42'),
(24, 3, 'Test', 'Super ! ', '2024-05-16 18:17:05');
...
ALTER TABLE `article_views`
  ADD CONSTRAINT `article_relation` FOREIGN KEY (`article_id`) REFERENCES `article` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
